...
{
  U, S, F, B, N,
  isObj, isNil, isArray, isInstance,
  def,
} = core.types;

const {copyProps} = core.obj;

const JQ = require('@lumjs/web-core/jq');
const isJQ = JQ.isMatch;

// Re-export a couple things.
Object.assign(exports, {ctx, JQ, isJQ});
 ...
 * 
 * @type {module:@lumjs/web-core}
 * @alias module:@lumjs/simple-loader/loader.web
 */
exports.web
  = ctx.isWindow 
  ? require('@lumjs/web-core')
  : null;
 ...
 * @param {*} val 
 * @returns {boolean}
 * @alias module:@lumjs/simple-loader/loader.optArr
 */
 ...
 * @param {*} val 
 * @returns {boolean}
 * @alias module:@lumjs/simple-loader/loader.optObj
 */
...
function getLoaderOpts(caller, args, ...objArgs)
{
  ...
  const GC   = context.settings.default;
  let opts;

  console.debug("getLoaderOpts", {caller, context, DEFS, GC});
